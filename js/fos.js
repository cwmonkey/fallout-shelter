import { sjcl } from "./DeEn.js";

// Copy/paste from https://github.com/rakion99/shelter-editor/blob/gh-pages/js/DeEn.js
// TODO: Seems wildly over-complex for a simple download script - probably just replace it later
...
function fix(json) {
  // Make a copy
  fixedJson = JSON.parse(JSON.stringify(json));
...
// Decrypts .sav data and puts it into json/fixedJson
...
// Returns json -> compact json -> blob
...
function downloadJson(json, fileName) {
  const prettyJsonStr = JSON.stringify(json, null, 2);
  const blob = new Blob([prettyJsonStr], {
...
// Download formatted, unscrubbed json
function downloadSavJson() {
  downloadJson(json, fileName.replace('.sav', '.json'));
}

// Download formatted, scrubbed json
...
// Read .sav file and put decrypted content into json/fixedJson via decrypt()
